 ...
 * A read only TileCache/MapCache layer.  Used to requests tiles cached by 
 *     TileCache or MapCache in a web accessible cache.  This means that you 
 *     have to pre-populate your cache before this layer can be used.  It is 
 *     meant only to read tiles created by the seeder on disk, and not to make 
 *     calls to TileCache or MapCache for tile creation.  Create a new instance 
 *     with the <OpenLayers.Layer.TileCache> constructor.
 *
 * Inherits from:
...
OpenLayers.Layer.TileCache = OpenLayers.Class(OpenLayers.Layer.Grid, {
    ...
    /**
     * APIProperty: cacheMode
     * {String} TileCache or MapCache. Defines the list of url parameters used.
     */
    cacheMode: "TileCache",
    
    /**
     * APIProperty: gridName
     * {String} Used only with the MapCache cache mode.
     */
    gridName: "g",
    ...
    initialize: function(name, url, layername, options) {
        ...
        if(this.cacheMode == "TileCache") {
            this.extension = (this.extension == 'jpg') ? 'jpeg' : this.extension;
        }

        this.globeExtent900913 = new OpenLayers.Bounds(
	...
	getMaxExtent: function() {
		return this.spherical_mercator?this.globeExtent900913:this.maxExtent;
	},
    ...
    getURL: function(bounds) {
        ...
        if(this.cacheMode == "MapCache") {
            components.splice(1, 0, this.gridName);
        }
