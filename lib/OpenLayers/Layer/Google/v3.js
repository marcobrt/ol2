...
OpenLayers.Layer.Google.v3 = {
    ...
    setGMapVisibility: function(visible) {
        ...
        if (cache) {
            ...
            if (visible === true) {
                if (container.parentNode !== this.map.div) {
                    if (!cache.rendered) {
                        //problems arised starting from gmaps 3.20
                        //original OL2 used a 'tilesloaded' gmap event.
                        //do it immediately, otherwise the map will be displaced with the wrong zoom
                        //another solution at https://github.com/openlayers/ol2/issues/1450#issuecomment-105954418
                        cache.rendered = true;
                    }
                ...
                if (this.map.div.contains(container)) {
  ...
  // Pixel
     ...
     * 
     * Parameters:
     * mapStyle: Array with custom styles information. For reference see:
     * https://developers.google.com/maps/documentation/javascript/styling
     * typeId: (optional) String, new GMapType of the layer; default is "styled".
     * 
     * Returns: Nothing
     */
    setStyled: function(mapStyle, typeId) {
        this.type = typeId || "styled";
        var styledMapType = new google.maps.StyledMapType(mapStyle, { name: this.type });
        this.mapObject.mapTypes.set(this.type, styledMapType);
    },

    /**
     * APIMethod: setStyleOptions
     * 
     * Parameters:
     * options: Array with custom styles information. For reference see:
     * https://developers.google.com/maps/documentation/javascript/styling
     * 
     * Returns: Nothing
     */
    setStyleOptions: function(options) {
