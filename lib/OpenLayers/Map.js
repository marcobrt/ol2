...
OpenLayers.Map = OpenLayers.Class({
  ...
  /********************************************************/         
    ...
    */    
     ...
     */
    //aggiunta opzione forceZoomChange con default true, per risolvere problema di mappa google che perde il centro 
    //se selezionata dopo mappa custom (non aggiornava i valori di minPx in moveTo) 
    setBaseLayer: function(newBaseLayer, forceZoomChange) {
        
        if (newBaseLayer != this.baseLayer) {
        	forceZoomChange = (forceZoomChange==undefined)?true:forceZoomChange;
            ...
            if (OpenLayers.Util.indexOf(this.layers, newBaseLayer) != -1) {
                ...
                if (center != null) {
                    ...
                    this.setCenter(center, newZoom, false, (oldResolution != newResolution) || forceZoomChange);
                }
  ...
  /********************************************************/     
     ...
     */
    updateSize: function(_force) {
    	_force = (_force==undefined)?false:_force;
        ...
        if (newSize && !isNaN(newSize.h) && !isNaN(newSize.w)) {
            ...
            if (_force || !newSize.equals(oldSize)) {
   ...
   /** 
    ...
    moveTo: function(lonlat, zoom, options) {
        ...
        if (zoomChanged || centerChanged || dragging) {
            ...
            var zoomEvent = options.zoomEvent==undefined ? true : options.zoomEvent;
            if(zoomChanged && zoomEvent) {
                this.events.triggerEvent("zoomstart", {
                    center: lonlat,
                    zoom: zoom
                });
            }
